...
<xsl:element name="a"><xsl:attribute name="href">
/cgi-bin/koha/opac-search.pl?q=sn:<xsl:value-of select="marc:subfield[@code='0']"/>
</xsl:attribute> <xsl:value-of select="marc:subfield[@code='t']"/></xsl:element>
</xsl:when>
<xsl:otherwise>
<xsl:element name="a"><xsl:attribute name="href">
...
/cgi-bin/koha/opac-search.pl?idx=index-lien-desc&amp;q=<xsl:value-of select="marc:subfield[@code='a'][1]"/>
