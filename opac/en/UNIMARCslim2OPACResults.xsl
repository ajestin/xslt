...
Pas d'exemplaire disponible </xsl:when>
<xsl:when test="count(key('item-by-status', 'available'))>0">
<span class="available">
<b><xsl:text>Exemplaire(s) empruntable(s): </xsl:text></b>
...
<span class="available">
<b><xsl:text>Exemplaires en consultation sur place :</xsl:text></b>
