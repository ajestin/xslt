...
<span class="results_summary">
<span class="label">Type of form&nbsp;: </span>
...
<xsl:text>See the abstract</xsl:text>
</a>
<xsl:choose><xsl:when test="position()=last()"><xsl:text>.</xsl:text></xsl:when><xsl:otherwise><xsl:text>; </xsl:text></xsl:otherwise></xsl:choose>
</xsl:for-each>
</span>
...
<span class="results_summary">
<span class="label">Collection summary&nbsp;: </span>
...
<span class="results_summary">
<span class="label">Collection summary deficencies</span>
...
<xsl:if test="marc:subfield[@code='z'] !=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='z']!=''"><xsl:value-of select="marc:subfield[@code='z']"/></xsl:if>
 </xsl:attribute><xsl:element name="img"><xsl:attribute name="src">/public/images/loupe.jpeg</xsl:attribute><xsl:attribute name="title">Search all the words</xsl:attribute></xsl:element> </xsl:element>
</span>
</xsl:for-each>
...
<xsl:if test="marc:subfield[@code='x'][2]!=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='x'][2]!=''"><xsl:value-of select="marc:subfield[@code='x'][2]"/></xsl:if>
<xsl:if test="marc:subfield[@code='x'][3]!=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='x'][3]!=''"><xsl:value-of select="marc:subfield[@code='x'][3]"/></xsl:if>
<xsl:if test="marc:subfield[@code='y'] !=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='y']!=''"><xsl:value-of select="marc:subfield[@code='y']"/></xsl:if><xsl:if test="marc:subfield[@code='z'] !=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='z']!=''"><xsl:value-of select="marc:subfield[@code='z']"/></xsl:if><xsl:if test="marc:subfield[@code='j'] !=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='j']!=''"><xsl:value-of select="marc:subfield[@code='j']"/></xsl:if></xsl:attribute> <xsl:element name="img"><xsl:attribute name="src">/public/images/loupe.jpeg</xsl:attribute><xsl:attribute name="title">Search all the words</xsl:attribute></xsl:element> </xsl:element>
</span>
</xsl:for-each>
...
<xsl:text> | </xsl:text>
<!-- recherche sur tous les mots --> <xsl:element name="a"><xsl:attribute name="href">/cgi-bin/koha/opac-search.pl?idx=su&amp;q=<xsl:value-of select="marc:subfield[@code='a']"/>
<xsl:if test="marc:subfield[@code='x'] !=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='x'][1]!=''"><xsl:value-of select="marc:subfield[@code='x'][1]"/></xsl:if> <xsl:if test="marc:subfield[@code='x'][2]!=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='x'][2]!=''"> <xsl:value-of select="marc:subfield[@code='x'][2]"/>  </xsl:if><xsl:if test="marc:subfield[@code='y'] !=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='y']!=''"><xsl:value-of select="marc:subfield[@code='y']"/></xsl:if><xsl:if test="marc:subfield[@code='z'] !=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='z']!=''"><xsl:value-of select="marc:subfield[@code='z']"/></xsl:if><xsl:if test="marc:subfield[@code='j'] !=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='j']!=''"><xsl:value-of select="marc:subfield[@code='j']"/></xsl:if></xsl:attribute> <xsl:element name="img"><xsl:attribute name="src">/public/images/loupe.jpeg</xsl:attribute><xsl:attribute name="title">Search all the words</xsl:attribute></xsl:element> </xsl:element>
</span>
</xsl:for-each>
...
<xsl:if test="marc:subfield[@code='z'] !=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='z']!=''"><xsl:value-of select="marc:subfield[@code='z']"/></xsl:if><xsl:if test="marc:subfield[@code='j'] !=''"><xsl:text>+</xsl:text></xsl:if> <xsl:if test="marc:subfield[@code='j']!=''"><xsl:value-of select="marc:subfield[@code='j']"/></xsl:if></xsl:attribute> <xsl:element name="img"><xsl:attribute name="src">/public/images/loupe.jpeg</xsl:attribute><xsl:attribute name="title">Search all the words</xsl:attribute></xsl:element> </xsl:element>
</span> 
</xsl:for-each>
